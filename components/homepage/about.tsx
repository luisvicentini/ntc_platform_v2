...
export default function About() {
  ...
  return (
    <section ref={ref} className="py-32 max-md:pb-0 px-4 max-md:px-0 lg:px-16 bg-[url('/homepage/bg-about.jpg')] bg-cover bg-no-repeat bg-right relative bg-[#f36444]">
      <motion.div
      ...
      >
        ...
        <div className="absolute max-md:relative bottom-0 right-0 max-md:-right-36 max-md:top-5">
