...
export default function RestaurantsSection() {
    ...
    <div key={category} className="mb-8">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          <button 
            ...
            className="p-2 rounded-full bg-zinc-800 hover:bg-zinc-500 text-zinc-300 hover:text-zinc-300"
      ...
      <div className="relative -mx-4">
        ...
        >
          ...
          >
            <div className="rounded-xl overflow-hidden group shadow-sm bg-zinc-50 border border-zinc-100 h-full flex flex-col">
              <div className="relative aspect-video bg-gradient-to-r from-zinc-200 to-zinc-300 flex items-center justify-center">
                <div className="absolute inset-0 bg-zinc-400 flex items-center justify-center">
                  <span className="text-3xl opacity-70"><Image className="grayscale" src="/logo.svg" alt="Em breve" width={100} height={100} /></span>
                </div>
              </div>
              <div className="p-4 space-y-1 flex-grow flex flex-col items-center justify-center text-center">
                <h3 className="font-semibold text-zinc-700">E vários outros em breve</h3>
                <p className="text-sm text-zinc-500">
  ...
  return (
    <section ref={ref} className="py-16 px-4 md:px-8 lg:px-16">
      <motion.div
