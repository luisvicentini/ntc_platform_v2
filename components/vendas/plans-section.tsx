...
export default function PlansSection() {
  ...
  return (
    <section ref={ref} className="py-16 px-4 md:px-8 lg:px-16" id="plans">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2 mb-4">
            Valores exclusivos de <span className="text-[#F24957]">lançamento</span>
          </h2>
          <p className="text-zinc-400 max-w-2xl mx-auto">
            Escolha o plano que melhor se adapta às suas necessidades. Cancele quando quiser sem burocracia.
          </p>
        </motion.div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`rounded-xl overflow-hidden relative ${
                plan.popular 
                  ? 'border-2 border-[#F24957] bg-zinc-900 transform md:scale-105 shadow-xl' 
                  : 'border border-zinc-700 bg-zinc-900'
              }`}
            >
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-[#F24957] text-white py-1 px-4 flex items-center rounded-bl-lg z-10">
              ...
              <div className="p-6">
                ...
                {plan.discountPercent && (
                  <div className="inline-block bg-[#4CAF50] text-white text-xs font-bold px-2 py-1 rounded-full mb-2">
                ...
                <div className="mb-6">
                  <h4 className="font-semibold mb-4 text-zinc-300">O que está incluído:</h4>
                  <ul className="space-y-2">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start">
                        <Check className="w-5 h-5 text-[#4CAF50] mr-2 flex-shrink-0 mt-0.5" />
