        ...
        >
          ...
          {isScrolled ? (
            ...
            >
              <Button
                variant="ghost"
                size="icon"
                className="text-white hover:bg-zinc-200 rounded-lg"
                onClick={() => setIsMenuOpen(true)}
                aria-label="Abrir menu"
              >
                <Menu className="h-5 w-5 sm:h-6 sm:w-6" />
          ...
          {isScrolled ? (
            <div className="flex flex-none items-center justify-end gap-2 max-sm:gap-1">
              <Button
              variant="ghost"
              className="text-zinc-800 rounded-xl hover:bg-zinc-200 px-2 py-2 sm:px-3 text-zinc-800 hover:text-zinc-800"
            ...
            >
              <ChevronsRight className="w-4 h-4 sm:mr-1 text-white" />
            ...
            <div className="flex flex-none items-center justify-end gap-2 max-sm:gap-1">
              <Button
              variant="ghost"
              className="text-zinc-800 rounded-xl hover:bg-zinc-200 px-2 py-2 sm:px-3 text-white hover:text-zinc-800"
              onClick={() => window.location.href = "/login"}
            >
              <User className="w-4 h-4 sm:mr-1" />
              <span className="sm:inline text-xs sm:text-sm ">
