...
export default function About() {
  ...
  return (
    <section ref={ref} className="pt-32 pb-32 max-sm:pt-12 max-sm:pb-0 max-md:pb-0 px-4 max-md:px-0 lg:px-16 bg-gradient-to-l from-zinc-100 to-zinc-200 bg-cover bg-no-repeat bg-right relative">
      <motion.div
      ...
      >
        <div className="flex flex-col max-md:mx-8 z-10">
          <h2 className="text-3xl md:text-4xl font-primary-ntc font-bold mb-8 text-left ml-20 max-md:ml-0 text-zinc-800">
            Quem é <span className="text-zinc-500 px-2 py-1">Leo Corvo</span>?
          </h2>
