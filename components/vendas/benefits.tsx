...
export default function Benefits({ isCarousel = false }: BenefitsProps) {
  ...
  return (
    <section className="py-12 px-4 md:px-8 lg:px-16 bg-white" id="benefits">
      {/* Título da seção */}
      ...
      {isCarousel ? (
        <div className="relative max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-4">
            <button 
              onClick={prevSlide}
              className="p-2 rounded-full bg-zinc-100 text-zinc-800 hover:bg-zinc-200 transition-colors"
            >
