      ...
      >
        <div
          className={`mx-auto flex w-full items-center justify-between gap-3 transition-all duration-300 
                      ${
                        isScrolled
                          ? "bg-zinc-950/90 backdrop-blur-sm shadow-md rounded-xl px-4 py-2 max-sm:px-2" // Estilo quando rolado
        ...
        >
          ...
          <div className="flex flex-none items-center justify-start gap-2 sm:gap-3 max-sm:gap-1">
            ...
            >
              <Button
                variant="ghost"
                size="icon"
                className="text-zinc-100 hover:bg-zinc-200 rounded-lg"
          ...
          <div className="flex flex-none items-center justify-end gap-2 max-sm:gap-1">
            <Button
              variant="ghost"
              className="text-zinc-100 rounded-xl hover:bg-zinc-200 px-2 py-2 sm:px-3"
              onClick={() => window.location.href = "/login"}
            >
              <User className="w-4 h-4 sm:mr-1" />
              <span className="sm:inline text-xs sm:text-sm text-zinc-100">
                Fazer login
              </span>
            </Button>
            <Button
