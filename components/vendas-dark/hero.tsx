...
export default function Hero({ showPriceBlock = true }: HeroProps) {
  ...
  return (
    <section
      ref={headerRef}
      className="relative pt-32 pb-4 px-4 md:px-8 lg:px-16 overflow-hidden bg-zinc-900 "
    >
      ...
      >
        <div className="flex items-center justify-center gap-1 bg-white rounded-full items-center justify-center shadow-md shadow-zinc-900 px-3 py-2 mb-4 mx-auto relative">
        ...
        <h1 className={`${fontPrimaryNTC.className} font-bold leading-[1.2] text-4xl max-sm:text-[1.4rem] lg:text-3xl mb-2 text-zinc-100`}>
      ...
      <div className="flex flex-col items-center justify-center mb-8 max-w-[900px] mx-auto">
        ...
        <button
          ...
          {/* Bloco de preco */}
          {showPriceBlock && (
            <p className="text-zinc-200 text-lg max-sm:text-[16px] pt-4 text-center">De <s className="text-red-500">R$99,90</s> por <span className="font-semibold text-green-600">R$49,90/mês</span> no plano anual</p>
          )}
        </motion.div>
      </div>
