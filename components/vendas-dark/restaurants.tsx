...
export default function Restaurants() {
  ...
  return (
    <section className="py-12 px-4 md:px-8 lg:px-16 relative bg-zinc-950">
      ...
      >
        <h2 className="max-md:w-[80%] lg:w-[80%] mx-auto font-bold line-height-3 max-sm:text-xl md:text-3xl lg:text-4xl text-center text-zinc-100">
