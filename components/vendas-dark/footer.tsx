...
export default function Footer() {
  ...
  return (
    <footer className="py-12 px-4 md:px-8 lg:px-16 bg-zinc-950 border-t border-zinc-800">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Coluna 1 - Contato */}
        <div className="text-center md:text-left">
          <h3 className="text-zinc-800 font-bold text-lg mb-4">Contato</h3>
          <ul className="space-y-2 text-zinc-400">
            <li>
              <a href="https://wa.me/5519996148651?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20o%20Não%20Tem%20Chef." className="hover:text-[#F24957] transition-colors">
