...
export default async function CheckoutPage({ params }: { params: { code: string } }) {
  ...
  // Verificar se é checkout Lastlink ou Stripe
  const isLastlinkCheckout = link.checkoutType === 'lastlink' || link.priceId?.startsWith('lastlink_')
    ...
    <div className="min-h-screen bg-zinc-100">
      ...
      <div className="max-w-3xl mx-auto -mt-24 px-4 pb-16">
        <div className="bg-white rounded-2xl overflow-hidden">
          {/* Componente de Preview do Checkout */}
          ...
          <div className="p-6 border-t border-zinc-200">
            <div className="flex items-center justify-center space-x-8">
              ...
              {/* Informação do Processador de Pagamento */}
